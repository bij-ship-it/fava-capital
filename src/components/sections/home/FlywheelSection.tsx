...
export function FlywheelSection() {
  return (
    <section
      id="flywheel"
      className="relative bg-base py-[200px] max-md:py-28 border-t border-border"
    ...
    >
      <Container>
        <div className="max-w-3xl mb-24">
          ...
          <p className="text-secondary mt-8 leading-[1.6] max-w-2xl">
            Every FAVA business is complete on its own. The ecosystem is the
            upside. Invest with one product, discover the others already
            fit &mdash; trade, pay, hold, hedge &mdash; all from a platform
            that works harder the more of it you use.
          </p>
        </div>
