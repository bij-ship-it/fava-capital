// Stream icons. Each uses a violet purple gradient for the structural
// elements (mirrors the brand mark) and the channel's accent colour
// for the signature line / accent. Channel accent colours match the
// tokens in src/app/globals.css and the FavaLogo brand mark.
//
// Channel accents:
//   Wealth       #3D8158  forest
//   Markets      #3B82F6  electric blue
//   Payments     #0891B2  cyan
//   Digital      #7C6EF3  violet
//   Commodities  #C47A3C  copper
...
export function WealthIcon({ size = 80, className = "" }: IconProps) {
  return (
    ...
    >
      ...
      />
      <circle cx="62" cy="12" r="3" fill="#3D8158" />
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <path
        ...
        strokeDasharray="3 4"
      />
      <rect x="58" y="10" width="12" height="4" rx="1" fill="#3B82F6" />
    </svg>
  );
}
...
export function DigitalIcon({ size = 80, className = "" }: IconProps) {
  return (
    ...
    >
      ...
      <rect x="30" y="30" width="20" height="20" rx="2" fill="#7C6EF3" />
      <rect x="35" y="35" width="10" height="10" rx="1" fill="#0D0B14" />
      <rect x="37" y="37" width="6" height="6" rx="0.5" fill="#7C6EF3" />
    </svg>
  );
}
...
export function CommoditiesIcon({ size = 80, className = "" }: IconProps) {
  return (
    <svg
      ...
      className={className}
    >
      <path d="M12 62 L20 54 L60 54 L68 62 Z" fill="#2D1B69" />
      <rect x="12" y="62" width="56" height="8" rx="1" fill="#2D1B69" />

      <path d="M16 50 L24 42 L56 42 L64 50 Z" fill="#4A2C8A" />
      <rect x="16" y="50" width="48" height="8" rx="1" fill="#4A2C8A" />

      <path d="M20 38 L28 30 L52 30 L60 38 Z" fill="#6B3FA0" />
      <rect x="20" y="38" width="40" height="8" rx="1" fill="#6B3FA0" />

      <path d="M24 26 L32 18 L48 18 L56 26 Z" fill="#8B5CF6" />
      <rect x="24" y="26" width="32" height="8" rx="1" fill="#8B5CF6" />

      <path d="M30 16 L36 10 L44 10 L50 16 Z" fill="#C47A3C" />
      <rect x="30" y="16" width="20" height="4" rx="0.5" fill="#C47A3C" />
    </svg>
  );
}

// FAVA Payments — card with money-flow arrows
